...
POST_COMMAND:=if [[ -d %BUILD_ABS%/sysroot_vmapp/x86_64-vmapp-elf/include/ ]]; then cp -Rf %HYPER_REL%/../include/pthread.h %BUILD_ABS%/sysroot_vmapp/x86_64-vmapp-elf/include/; fi
